...
while ( $nd < $nnode )
        gmx_gpu trjconv -s ${nd}/${proot}_${ff}_${this}_nd.tpr \
                ...
                -drop data/hills/${nd}/2000ns_conditions_Q_0.55-0.73_rg_1.2-1.9.xvg -dropunder 0.25 \
                -o data/subtrajectory/2000ns_${proot}_${ff}_${this}_nd${nd}_prot_Q_0.55-0.73_rg_1.2-1.9.xtc<<EOD
1
EOD
	@ nd++
end
