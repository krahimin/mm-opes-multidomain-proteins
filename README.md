...
│   └── analysis/scripts/         # Analysis and post-processing scripts
├── notebooks/                    # Clean plotting and analysis notebooks
├── examples/                     # Small example inputs, if added later
...
6. Clean and combine outputs with `workflow/analysis/scripts/all_data.csh`.
7. Run analysis scripts for Rg, DSSP, Ramachandran, subtrajectories, clustering, and contact maps.
8. Plot and inspect results in `notebooks/2B-linker.ipynb`.
